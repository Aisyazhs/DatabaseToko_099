...
import percobaan.ws.a.exceptions.PreexistingEntityException;
...
public class BaranggJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("percobaan_ws.a_jar_0.0.1-SNAPSHOTPU");
